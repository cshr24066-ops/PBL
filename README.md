...
Python3​（開発言語），​PySide6​（GUIフレームワーク），​Gemini API​（AIチャット機能），​VoiceVox Engine​（音声合成機能），​requests​（通信ライブラリ）​
gif​（キャラクタ表示），​PyInstaller​（実行形式）​

作らない​もの​

多様的な機能の​拡張性は​一旦​考慮しない．​

サブ機能​一覧

VoiceVox等で​メッセージに​音声を​付ける．​
...
作業中に​親しみの​ある​キャラクタを​常駐．​チャットに​よる​簡易な​会話を​行う．​AIの​返答は​音声再生する．​

​入力

ユーザ入力は​テキスト，​システム入力は​AI APIからの​テキストデータ，​VoiceVox APIからの​音声データ

出力

画面出力は​画像と​応答テキストと​応答音声

制約

Windows環境で​動作．​​開発期間は​4週程度，​人数は​一人．​拡張機能は​一切​考慮しない．​

非​目標

スケジューリング，​複数キャラクタ管理，​長期記憶能，​感情モデル，​クラウド同期，​モバイル版，​認証，​音声入力

コア機能

キャラクタ表示，​テキスト入力，​AI応答生成，​チャット履歴確認，​音声再生，​キャラクタ状態切り​替え

サポート​機能

キャラクタ位置移動，​ウィンドウ最前面表示，​応答中​表示

共通機能

API通信，​VoiceVox通信，​エラーハンドリング​（API失敗時の​処理），​設定管理​（APIキーや​各種設定保持）​
